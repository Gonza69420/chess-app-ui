...
class PieceWithSpecialMove(override val id : Int, override val color: Color, override val type: String, override val validator: List<ValidatorMove>, override val data: HashMap<String , Integer>, private val specialMoves : List<SpecialValidatorMove>, override val dead : Boolean = false) : Piece {
